...
const Navbar = () => {
  return (
    ...
    <Stack direction='row' justifyContent='space-between' backgroundColor='#F2EFC7' boxShadow='10px 10px 8px #888888;' sx={{gap: {sm: '2rem', xs: '1rem'}, mt: {sm: '0rem', xs: '.5rem'}, justifyContent: 'none'}} >
